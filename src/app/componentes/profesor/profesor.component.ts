...
export class ProfesorComponent implements OnInit {
  ...
  constructor(private profesor: Profesor,private subopcionPestaniaServicio: SubopcionPestaniaService, private profesorService: ProfesorService, private toastr: ToastrService) {
    this.autocompletado.valueChanges.subscribe(data => {
      if(typeof data == 'string') {
        this.profesorService.listarPorNombre(data).subscribe(res => {
  ...
  ngOnInit() {
    ...
    this.formulario= this.profesor.formulario;
...
//Obtiene el ID del modulo traido desde la base de datos y lo muestra en el campo id del formulario.
  ...
  private actualizar(){
    this.profesorService.actualizar(this.formulario.value).subscribe(
      res => {
        var respuesta = res.json();
