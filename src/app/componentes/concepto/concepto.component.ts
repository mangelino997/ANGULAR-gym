...
export class ConceptoComponent implements OnInit {
  ...
  constructor(private concepto: Concepto ,private conceptoService: ConceptoService ,private subopcionPestaniaServicio: SubopcionPestaniaService, private toastr: ToastrService) {
    this.autocompletado.valueChanges.subscribe(data => {
      if(typeof data == 'string') {
        this.conceptoService.listarPorAlias(data).subscribe(res => {
